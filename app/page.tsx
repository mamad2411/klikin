...
export default function KasirPintarPage() {
  ...
  // Detect mobile/tablet for video positioning adjustments
  useEffect(() => {
    const checkMobile = () => {
  ...
  return (
    <div className="bg-[#F5F4F0] text-[#111] min-h-screen w-full font-sans antialiased overflow-x-hidden relative">

      {/* ── HERO ──────────────────────────────────────────────────────────── */}
      <section className="relative w-full h-[100dvh] min-h-[600px] overflow-hidden">

        {/* Video background — forced cover and full size */}
        ...
        {/* Progressive gradient rising from bottom - disesuaikan untuk mobile agar lebih lembut */}
        <div 
          ...
          style={{ 
            ...
            background: isMobile 
              ? "linear-gradient(to top, #F5F4F0 0%, #F5F4F0 15%, rgba(245,244,240,0.98) 30%, rgba(245,244,240,0.9) 50%, rgba(245,244,240,0.6) 70%, rgba(245,244,240,0.3) 85%, transparent 100%)"
              : "linear-gradient(to top, #F5F4F0 0%, #F5F4F0 20%, rgba(245,244,240,0.98) 35%, rgba(245,244,240,0.85) 50%, rgba(245,244,240,0.5) 65%, rgba(245,244,240,0.2) 80%, transparent 100%)",
            contain: "layout style paint",
            zIndex: 1,
          }} 
        />

        {/* Title + metrics — anchored to bottom left, dengan spacing yang lebih baik di mobile */}
        <div className="absolute inset-x-0 bottom-0 flex flex-col px-6 md:px-12 pb-16 sm:pb-12 max-w-3xl pt-[88px]" style={{ zIndex: 2 }}>
          {/* Title - ukuran font disesuaikan untuk mobile */}
          <h1
            className="text-4xl sm:text-7xl md:text-8xl font-light text-[#111] leading-[1.1] sm:leading-[1.05] md:leading-[1.0] tracking-tight mb-6 sm:mb-10"
            style={{
          ...
          {/* 3 metrics — stacking lebih rapi di mobile */}
          <div className="flex flex-wrap gap-6 sm:gap-8 md:gap-12">
            {[
              ...
              >
                <div className="text-2xl sm:text-3xl md:text-4xl text-[#111] font-light tracking-tight" style={{ fontFamily: '"IBM Plex Sans", sans-serif' }}>{stat.value}</div>
      ...
      <section id="platform" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-12 lg:px-20 -mt-2 relative z-10 bg-[#F5F4F0]">
        <div className="max-w-6xl mx-auto">
          <div className="mb-10 sm:mb-16">
            <PixelIcon type="platform" size={40} />
            <div className="mt-4"><Tag>FITUR LENGKAP</Tag></div>
            <RevealText className="mt-5 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light tracking-tight leading-[1.1] sm:leading-[1.05]">
          ...
          <div className="grid grid-cols-12 grid-rows-auto gap-3" onMouseMove={handleMouse}>
            ...
            <BentoCard className="col-span-12 p-6 sm:p-8 min-h-[200px] flex flex-col justify-between relative overflow-hidden" delay={0}>
              {/* Image Background */}
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-lg sm:text-xl font-light mb-2 sm:mb-3 text-white">Point of Sales (POS)</h3>
            ...
            {/* Bottom row */}
            <BentoCard className="col-span-12 sm:col-span-6 md:col-span-4 p-6 sm:p-8 min-h-[180px] sm:min-h-[200px]" delay={120}>
              ...
              <h3 className="text-base sm:text-lg font-light mb-2">Manajemen Stok Barang</h3>
              <p className="text-xs sm:text-sm text-black/45 leading-relaxed">Atur dan monitoring pengelolaan stok barang yang tersedia di sistem dan gudang secara akurat.</p>
            </BentoCard>

            <BentoCard className="col-span-12 sm:col-span-6 md:col-span-4 p-6 sm:p-8 min-h-[180px] sm:min-h-[200px]" delay={160}>
              <div className="w-10 h-10 rounded-xl border border-black/10 flex items-center justify-center mb-5">
              ...
              <h3 className="text-base sm:text-lg font-light mb-2">Pembayaran Digital QRIS & Crypto</h3>
              <p className="text-xs sm:text-sm text-black/45 leading-relaxed">Lengkapi kebutuhan transaksi dengan QRIS, cryptocurrency, dan metode pembayaran lainnya hanya dengan scan barcode.</p>
            </BentoCard>

            <BentoCard className="col-span-12 sm:col-span-6 md:col-span-4 p-6 sm:p-8 min-h-[180px] sm:min-h-[200px]" delay={200}>
              <div className="w-10 h-10 rounded-xl border border-black/10 flex items-center justify-center mb-5">
              ...
              <h3 className="text-base sm:text-lg font-light mb-2">Laporan Usaha Lengkap</h3>
              <p className="text-xs sm:text-sm text-black/45 leading-relaxed">Nikmati akses laporan usaha lengkap dari aplikasi kasir dimana saja dan kapan saja.</p>
            </BentoCard>
          </div>
        </div>
      </section>
      ...
      <section id="business" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 sm:gap-8 mb-10 sm:mb-16">
            <div>
              ...
              <RevealText className="mt-5 text-3xl sm:text-4xl md:text-5xl font-light tracking-tight leading-[1.1] sm:leading-[1.05]">
                {"Cocok untuk semua\nbidang usaha."}
              </RevealText>
            </div>
            <p className="text-xs sm:text-sm text-black/45 leading-relaxed max-w-xs">
      ...
      {/* ── APLIKASI PENDUKUNG ──────────────────────────────────────────────────── */}
      <section id="apps" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-12 lg:px-20 border-t border-black/[0.06] overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <div className="mb-10 sm:mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3" onMouseMove={handleMouse}>
            {[
              ...
              <BentoCard key={step.n} className="relative overflow-hidden flex flex-col min-h-[300px] sm:min-h-[320px]" delay={step.delay}>
                {/* Image at top — mask fades it out strongly before the bottom edge */}
                <div className="absolute inset-x-0 top-0 h-48 sm:h-56 pointer-events-none">
                  <OptimizedImage
                    src={step.img}
                    alt={step.title}
                    loading="lazy"
                ...
                <div className="relative z-10 p-5 sm:p-7">
                  <span className="font-pixel text-[10px] sm:text-[11px] text-black/20 tracking-widest block">{step.n}</span>
                </div>
                {/* Text pushed further down */}
                <div className="relative z-10 px-5 sm:px-7 pb-5 sm:pb-7 mt-auto pt-12 sm:pt-16">
                  <h3 className="text-xl sm:text-2xl font-light mb-2 sm:mb-3">{step.title}</h3>
                  <p className="text-xs sm:text-sm text-black/45 leading-relaxed mb-3 sm:mb-4">{step.desc}</p>
                  <a href="#pricing" className="inline-flex items-center gap-2 text-xs sm:text-sm text-black/70 hover:text-black font-medium transition-colors">
          ...
          <div className="flex justify-center mt-6 sm:mt-8">
            <a href="#pricing" className="inline-block px-6 sm:px-8 py-2.5 sm:py-3 bg-[#111] hover:bg-[#333] text-white rounded-full font-semibold transition-all duration-300 shadow-lg shadow-black/10 hover:scale-105 active:scale-95 text-xs sm:text-sm uppercase tracking-widest">
              Lihat Semua Fitur
            </a>
          </div>
        </div>
      ...
      {/* ── INTEGRATIONS ──────────────────────────────────────────────────── */}
      <section id="integrations" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 sm:gap-8 mb-10 sm:mb-16">
            <div>
          ...
          <div className="rounded-2xl overflow-hidden border border-black/[0.07] flex flex-col md:block md:relative" onMouseMove={handleMouse}>
            {/* Image */}
            <div className="relative w-full h-[300px] sm:h-[400px] md:h-[600px] shrink-0">
              <OptimizedImage
              ...
              <div className="absolute bottom-4 sm:bottom-6 md:bottom-8 left-4 sm:left-6 md:left-8">
                <a href="#pricing" className="inline-block px-6 sm:px-8 md:px-10 py-2.5 sm:py-3 md:py-4 bg-[#111] hover:bg-[#333] text-white rounded-full font-semibold transition-all duration-300 shadow-2xl shadow-black/20 hover:scale-110 active:scale-95 text-xs sm:text-sm uppercase tracking-widest backdrop-blur-sm">
                  Uji Coba Kasir
                </a>
              </div>
            </div>

            {/* Cards — stacking di mobile, absolute di desktop */}
            <div className="flex flex-col gap-3 p-3 sm:p-4 md:absolute md:bottom-4 md:right-4 md:p-0 md:w-72">
              <div
                className="rounded-xl border border-white/50 p-4 sm:p-5 md:p-6"
                style={{
              ...
              >
                ...
                <h3 className="mt-2 sm:mt-3 text-base sm:text-lg font-light mb-2">Gratis 3 Bulan Penuh</h3>
                <p className="text-[11px] sm:text-xs text-black/45 leading-relaxed mb-3 sm:mb-4">Tanpa kartu kredit. Tanpa biaya tersembunyi. Cukup daftar dan langsung pakai semua fitur premium selama 3 bulan!</p>
                <div className="flex gap-2 flex-wrap">
                  {["Unlimited", "Full Fitur", "No CC"].map(item => (
                    <span key={item} className="px-2 py-1 rounded-md bg-emerald-500/10 text-[9px] sm:text-[10px] text-emerald-700 font-medium">
                      {item}
                    </span>
                  ))}
                </div>
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-emerald-500/80 animate-pulse" />
                  <span className="text-[10px] sm:text-xs text-black/40 tracking-widest uppercase">SIAP DALAM 5 MENIT</span>
                </div>
                <h3 className="text-base sm:text-lg font-light mb-2">Setup Super Cepat</h3>
                <p className="text-[11px] sm:text-sm text-black/45 leading-relaxed">Daftar, input produk, langsung jualan. Tidak perlu training rumit atau instalasi lama. Bisnis Anda bisa jalan hari ini juga!</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="security" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-6xl mx-auto">
          <div className="mb-10 sm:mb-16">
            <PixelIcon type="platform" size={40} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-start">
            ...
            <div className="space-y-6 sm:space-y-8">
              <p className="text-base sm:text-lg text-black/50 font-light leading-relaxed max-w-md">
              ...
              <div className="space-y-4 sm:space-y-6">
                {[
                  ...
                  <div key={item.label} className="group flex gap-4 sm:gap-5 p-3 sm:p-4 rounded-2xl transition-colors hover:bg-black/[0.02]">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-white border border-black/[0.05] shadow-sm flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-300">
                      {item.icon}
                    </div>
                    <div>
                      <h3 className="text-sm sm:text-base font-medium mb-1 text-black/80">{item.label}</h3>
                      <p className="text-xs sm:text-sm text-black/40 leading-relaxed font-light">{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="pt-6 sm:pt-8 flex flex-wrap gap-3 sm:gap-4">
                {["ISO 27001", "Keamanan Data", "Cloud Secure"].map((badge) => (
                  <div key={badge} className="flex items-center gap-2 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-lg bg-white border border-black/[0.04] shadow-sm text-[9px] sm:text-[10px] font-medium text-black/40 tracking-wider uppercase">
            ...
            <div className="relative group">
              ...
              <BentoCard className="relative p-0 border-black/[0.08] shadow-2xl" delay={0}>
                {/* Dashboard Header */}
                <div className="px-4 sm:px-6 py-3 sm:py-5 border-b border-black/[0.05] bg-black/[0.01] flex items-center justify-between">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-emerald-500 animate-pulse" />
                    <span className="text-[9px] sm:text-[10px] font-bold tracking-[0.2em] text-black/30 uppercase">Log Audit Keamanan</span>
                  </div>
                  <div className="px-1.5 sm:px-2 py-0.5 sm:py-1 rounded bg-emerald-50 text-[8px] sm:text-[9px] font-bold text-emerald-600 border border-emerald-100 uppercase tracking-wider">
                    Secure
                  </div>
                </div>
                ...
                <div className="p-3 sm:p-4 space-y-1">
                  {[
                    ...
                    <div
                      key={i}
                      className="flex items-center gap-2 sm:gap-4 px-3 sm:px-4 py-2 sm:py-3 rounded-xl hover:bg-black/[0.02] transition-colors group/item"
                      style={{
                        animation: `fadeInUp 0.5s cubic-bezier(0.16,1,0.3,1) ${i * 80}ms both`,
                      }}
                    >
                      <span className="text-[9px] sm:text-[10px] text-black/20 font-mono w-12 sm:w-14 shrink-0">{log.time}</span>
                      <div className="flex-1 min-w-0">
                        <div className="text-[10px] sm:text-[11px] text-black/70 font-medium truncate uppercase tracking-wide group-hover/item:text-black transition-colors">{log.action.replace(/_/g, ' ')}</div>
                        <div className="text-[8px] sm:text-[9px] text-black/30 font-mono mt-0.5">user: {log.user}</div>
                      </div>
                      <CheckCircle2 size={12} className="sm:w-[14px] sm:h-[14px] text-emerald-500/40 group-hover/item:text-emerald-500 transition-colors" />
                    </div>
                  ))}
                </div>

                {/* Footer Status */}
                <div className="px-4 sm:px-6 py-3 sm:py-4 bg-black/[0.02] border-t border-black/[0.03] flex justify-between items-center">
                  <div className="flex gap-1">
                    {[0, 1, 2].map(dot => (
                      <div key={dot} className="w-0.5 h-0.5 sm:w-1 sm:h-1 rounded-full bg-black/10" />
                    ))}
                  </div>
                  <span className="text-[8px] sm:text-[9px] text-black/20 font-mono uppercase tracking-widest">Encrypted Connection active</span>
                </div>
              </BentoCard>
            </div>
          </div>
          ...
          {[...Array(3)].map((_, rep) => (
            <div key={rep} className="flex shrink-0">
              {["Cetak Struk", "Scan Barcode", "Laporan Penjualan", "Manajemen Stok", "QRIS Payment", "Multi Cabang", "Diskon Produk", "Manajemen Staf", "Pajak & Biaya", "Dashboard Web"].map((cap) => (
                <div key={cap} className="flex items-center gap-3 sm:gap-6 px-6 sm:px-10 py-3 sm:py-5 border-r border-black/[0.06] shrink-0">
                  <span className="text-xs sm:text-sm text-black/45 whitespace-nowrap tracking-wide">{cap}</span>
                </div>
              ))}
            </div>
          ))}
          ...
          {[...Array(3)].map((_, rep) => (
            <div key={rep} className="flex shrink-0">
              {["Integrasi Marketplace", "Sync Cloud", "Offline Mode", "Riwayat Transaksi", "Manajemen Pelanggan", "Program Loyalitas", "Analisa Bisnis", "Print Thermal", "Export Excel", "Notifikasi Stok"].map((cap) => (
                <div key={cap} className="flex items-center gap-3 sm:gap-6 px-6 sm:px-10 py-3 sm:py-5 border-r border-black/[0.06] shrink-0">
                  <span className="text-xs sm:text-sm text-black/30 whitespace-nowrap tracking-wide">{cap}</span>
                </div>
              ))}
            </div>
          ))}
      ...
      {/* ── LIVE AGENTS ──────────────────────────────────────────────────── */}
      <section id="live" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-20 items-center">
            <div>
              ...
              <p className="mt-5 sm:mt-6 text-sm sm:text-base text-black/40 leading-relaxed max-w-sm">
                Di mana pun Anda berada, ribuan transaksi diproses secara real-time oleh bisnis di seluruh Indonesia — tanpa hambatan.
              </p>
              <div className="mt-8 sm:mt-10 flex items-end gap-2">
                <LiveAgentCounter />
                <span className="text-black/30 text-xs sm:text-sm mb-1 tracking-wide">transaksi diproses hari ini</span>
              </div>
            </div>
      ...
      {/* ── FAQ ────────────────────────────────────────────────── */}
      <section className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
      ...
      {/* ── PENAWARAN TERBAIK ────────────────────────────────────────────────── */}
      <section id="pricing" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-6xl mx-auto">
          <PromoSection />
        </div>
        <style>{`
      ...
      {/* ── CTA ───────────────────────────────────────────────────────────── */}
      <section className="relative py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-12 lg:px-20 border-t border-black/[0.06] overflow-hidden">
        <OptimizedImage
          src="/images/footer/footer.webp"
          alt=""
          loading="lazy"
        ...
        />
        <div className="relative z-10 max-w-2xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light tracking-tight leading-[1.1] sm:leading-[1.05] mb-4 sm:mb-6 text-black lg:text-white">
            Mulai bisnis bersama<br />Klikin.
          </h2>
          <p className="text-xs sm:text-sm text-black/60 lg:text-white/80 leading-relaxed mb-6 sm:mb-10">
            Jalankan bisnis secara otomatis dengan Aplikasi Kasir Pintar dan coba gratis selama 3 bulan tanpa syarat.
          </p>
          {!submitted ? (
            <form
            ...
            >
              <input
                ...
                onChange={e => setEmail(e.target.value)}
                required
                className="flex-1 bg-white border border-black/10 rounded-xl px-4 py-2.5 sm:py-3 text-sm text-[#111] placeholder:text-black/25 focus:outline-none focus:border-black/25 transition-colors"
              />
              <button
                type="submit"
                className="px-6 sm:px-8 py-2.5 sm:py-3 bg-[#111] text-white text-xs sm:text-sm rounded-xl hover:bg-[#333] transition-colors tracking-widest font-medium"
              >
                COBA GRATIS
              </button>
            </form>
          ) : (
            <div className="inline-flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 rounded-xl border border-emerald-600/20 bg-emerald-50 text-emerald-700 text-xs sm:text-sm">
              <div className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
              {"Terima kasih! Kami akan segera menghubungi Anda."}
            </div>
          )}
