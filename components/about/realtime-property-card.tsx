...
const defaultTopProperties = [
  { page: "Toko Kelontong Berkah", visitors: 245 },
  { page: "Warung Makan Sedap", visitors: 189 },
  { page: "Bengkel Jaya Motor", visitors: 156 },
  { page: "Laundry Kilat", visitors: 98 },
]
    ...
    >
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <h3 className="text-lg font-semibold text-slate-900">Aktivitas Bisnis</h3>
      ...
      <div className="mb-6 grid grid-cols-2 gap-4">
        ...
        >
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-sm opacity-80">Pembeli Online</p>
          </div>
      ...
      <div>
        <p className="mb-3 text-sm font-medium text-slate-700">Produk Terlaris</p>
