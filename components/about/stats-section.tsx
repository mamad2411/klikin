...
export function StatsSection() {
  ...
  const homes = useCountUp(50, 2000, "K+")
  const cities = useCountUp(25, 2000, "")
  const users = useCountUp(100, 2000, "K+")
      ...
      <div className="max-w-4xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
          ...
          >
            ...
            <p className="text-xs text-muted-foreground uppercase tracking-wider">Kota di Indonesia</p>
          </div>
