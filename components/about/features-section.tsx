...
const features = [
  "Setup kasir hanya dalam 5 menit",
  "Laporan penjualan otomatis & akurat",
  "Manajemen stok barang real-time",
  "Dukungan teknis 24/7",
  "Tanpa biaya langganan tersembunyi",
  "Sistem pembayaran aman & terintegrasi",
]
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-normal mb-6 text-balance font-serif">
                Kelola Usaha Semudah Senyuman
              </h2>
              <p className="text-muted-foreground leading-relaxed text-lg">
                Pantau stok barang, catat penjualan, hingga kelola karyawan dalam satu genggaman. Klikin dirancang khusus untuk Anda yang ingin fokus melayani pelanggan tanpa pusing urusan pembukuan.
              </p>
            </motion.div>
