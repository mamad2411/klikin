...
const AGENTS = [
  {
    ...
    desc: "Proses pembayaran QRIS, Tunai, dan Digital dalam hitungan detik. Cetak struk atau kirim struk digital langsung ke pelanggan.",
    stats: [{ v: "180M+", l: "transaksi" }, { v: "0.2s", l: "kecepatan" }],
  ...
  },
  {
    ...
    desc: "Pantau stok produk secara real-time. Notifikasi stok menipis dan integrasi multi-gudang untuk memudahkan operasional Anda.",
    stats: [{ v: "1.2M+", l: "produk dikelola" }, { v: "100%", l: "sinkron" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/coder-9bItvCegU6TXUqbX3tUXGBAtvkBkXp.png",
  },
  {
    label: "REPORTING",
    title: "Analisa bisnis mendalam",
    desc: "Laporan harian, mingguan, hingga tahunan otomatis. Analisa produk terlaris dan jam sibuk untuk strategi bisnis yang tepat.",
    stats: [{ v: "50+", l: "jenis laporan" }, { v: "Real-time", l: "data" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/analyst-Ysxnqg7Fpy2cfA56PiIttv1KximMhT.png",
  },
  {
    label: "STAFF MANAGEMENT",
    title: "Kelola tim dengan mudah",
    desc: "Atur hak akses staf, pantau absensi, dan hitung komisi penjualan otomatis dalam satu dashboard terintegrasi.",
    stats: [{ v: "300K+", l: "staf aktif" }, { v: "Easy", l: "setup" }],
...
export const StackingAgentCards = memo(function StackingAgentCards() {
